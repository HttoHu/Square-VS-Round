...
namespace Widgets
{
    ...
    ColorRGB get_color_rgb(ColorTag color_tag)
    {
        const std::map<ColorTag, ColorRGB> table = {
            {ColorTag::WHITE, ColorRGB{255, 255, 255}}, {ColorTag::BLACK, ColorRGB{0, 0, 0}}, {ColorTag::GREEN, ColorRGB{56, 208, 78}}, {ColorTag::RED, ColorRGB{236, 53, 53}}, {ColorTag::PINK, ColorRGB{255, 174, 200}}};
    ...
    TTF_Font *get_font_by_size(FontSize font_size)
    {
        const std::map<FontSize, TTF_Font *> table = {
            {FontSize::BIG, vars::big_font}, {FontSize::NORMAL, vars::main_font}, {FontSize::SMALL, vars::small_font}};
    ...
    SDL_Texture *print_text(const std::wstring &str, TTF_Font *font, ColorTag c)
    {
        ...
        SDL_Surface *surface = TTF_RenderUNICODE_Blended_Wrapped(font, (uint16_t *)str.c_str(), color, 10000);
